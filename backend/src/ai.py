...
- Exceptionally compelling moments may be longer if every part contributes meaningful value.
...
- Avoid selecting multiple clips that communicate the same idea.
